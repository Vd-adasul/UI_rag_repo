      ...
      <main className="flex-grow">
        ...
        <section className="relative w-full py-24 md:py-36 lg:py-48 bg-gradient-to-br from-blue-700 to-purple-800 text-white flex items-center justify-center text-center overflow-hidden">
          ...
          <div className="relative z-10 container px-4 md:px-6 max-w-5xl">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tight leading-tight mb-8 text-balance">
              Empowering Campus Communication: <br className="hidden md:inline"/> Your Multilingual AI Assistant
            </h1>
            <p className="text-lg md:text-xl lg:text-2xl max-w-3xl mx-auto mb-10 opacity-90 font-light">
            ...
            <Button asChild size="lg" className="bg-white text-blue-800 hover:bg-gray-100 hover:text-blue-900 text-lg px-10 py-7 rounded-full shadow-lg transition-all duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105">
              <Link to="/signup">
        ...
        <section className="py-20 md:py-32 bg-gray-50 dark:bg-gray-950">
          <div className="container px-4 md:px-6 text-center max-w-6xl">
            <h2 className="text-3xl md:text-5xl font-bold mb-6 text-gray-900 dark:text-white text-balance">Key Features</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              <div className="bg-white dark:bg-gray-800 p-10 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100 dark:border-gray-700">
        ...
        <section className="py-20 md:py-32 bg-gray-100 dark:bg-gray-900">
          <div className="container px-4 md:px-6 text-center max-w-6xl">
            <h2 className="text-3xl md:text-5xl font-bold mb-6 text-gray-900 dark:text-white text-balance">How It Works</h2>
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-16">
              A simple, powerful process to enhance campus communication.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
              <div className="flex flex-col items-center text-center p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700">
                <div className="bg-blue-500 text-white p-4 rounded-full mb-6 shadow-md">
              ...
              <div className="flex flex-col items-center text-center p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700">
                <div className="bg-green-500 text-white p-4 rounded-full mb-6 shadow-md">
              ...
              <div className="flex flex-col items-center text-center p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700">
                <div className="bg-purple-500 text-white p-4 rounded-full mb-6 shadow-md">
              ...
              <div className="flex flex-col items-center text-center p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700">
                <div className="bg-red-500 text-white p-4 rounded-full mb-6 shadow-md">
        ...
        <section className="py-20 md:py-32 bg-white dark:bg-gray-800">
          <div className="container px-4 md:px-6 text-center max-w-6xl">
            <h2 className="text-3xl md:text-5xl font-bold mb-6 text-gray-900 dark:text-white text-balance">Benefits for Your Campus</h2>
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-16">
              Transforming student support and administrative efficiency.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16">
              <div className="flex flex-col items-center text-center p-8 bg-gray-50 dark:bg-gray-900 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
                <div className="bg-blue-100 dark:bg-blue-900 p-5 rounded-full mb-6 shadow-md">
                  <span className="text-blue-600 dark:text-blue-300 text-4xl font-bold">24/7</span>
                </div>
              ...
              <div className="flex flex-col items-center text-center p-8 bg-gray-50 dark:bg-gray-900 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
                <div className="bg-green-100 dark:bg-green-900 p-5 rounded-full mb-6 shadow-md">
                  <span className="text-green-600 dark:text-green-300 text-4xl font-bold">🚀</span>
                </div>
              ...
              <div className="flex flex-col items-center text-center p-8 bg-gray-50 dark:bg-gray-900 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
                <div className="bg-purple-100 dark:bg-purple-900 p-5 rounded-full mb-6 shadow-md">
                  <span className="text-purple-600 dark:text-purple-300 text-4xl font-bold">🤝</span>
                </div>
              ...
              <div className="flex flex-col items-center text-center p-8 bg-gray-50 dark:bg-gray-900 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
                <div className="bg-yellow-100 dark:bg-yellow-900 p-5 rounded-full mb-6 shadow-md">
                  <span className="text-yellow-600 dark:text-yellow-300 text-4xl font-bold">⚖️</span>
                </div>
        ...
        <section className="py-20 md:py-32 bg-gradient-to-r from-blue-600 to-indigo-700 text-white text-center">
          <div className="container px-4 md:px-6 max-w-5xl">
            <h2 className="text-3xl md:text-5xl font-bold mb-6 text-balance">Ready to Transform Campus Communication?</h2>
            <p className="text-lg md:text-xl max-w-3xl mx-auto mb-10 opacity-90 font-light">
              Join us in building a smarter, more inclusive educational environment.
            </p>
            <Button asChild size="lg" className="bg-white text-indigo-800 hover:bg-gray-100 hover:text-indigo-900 text-lg px-10 py-7 rounded-full shadow-lg transition-all duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105">
              <Link to="/signup">
