      ...
      <main className="flex-grow flex items-center justify-center p-6 md:p-8">
        <Card className="w-full max-w-md p-6 rounded-xl shadow-2xl border border-gray-100 dark:border-gray-700">
          <CardHeader className="text-center mb-6">
            <CardTitle className="text-3xl font-bold text-gray-900 dark:text-white">Create Your Account</CardTitle>
            <CardDescription className="text-gray-600 dark:text-gray-400 text-lg mt-2">
              Get started with the Multilingual AI Chatbot today.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form className="grid gap-6">
              ...
              <div className="grid gap-2">
                <Label htmlFor="confirm-password" className="text-lg font-medium text-gray-800 dark:text-gray-200">Confirm Password</Label>
                <Input id="confirm-password" type="password" required className="h-12 text-base px-4 rounded-lg border-gray-300 dark:border-gray-600 focus:ring-blue-500 focus:border-blue-500" />
              </div>
            ...
            <div className="mt-8 text-center text-base text-gray-600 dark:text-gray-400">
              ...
              <Link to="/login" className="underline text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 font-medium">
                Login
              </Link>
            </div>
          </CardContent>
